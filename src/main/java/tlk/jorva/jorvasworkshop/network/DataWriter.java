...
import static tlk.jorva.jorvasworkshop.main.JorVasWorkshop.packetHandler;
...
//	}
	...
	private FMLProxyPacket createPacket() {
		writeFinalBits();
		return new FMLProxyPacket(new PacketBuffer(stream), StringMap.Channel);
	}
	...
	public void writeBoolean(boolean data) {
		writeData(data ? 1 : 0, tlk.jorva.jorvasworkshop.network.StandardCounts.BOOLEAN);
	}

	public void writeByte(int data) {
		writeData(data, tlk.jorva.jorvasworkshop.network.StandardCounts.BYTE);
	}

	public void writeShort(int data) {
		writeData(data, tlk.jorva.jorvasworkshop.network.StandardCounts.SHORT);
	}

	public void writeInteger(int data) {
		writeData(data, tlk.jorva.jorvasworkshop.network.StandardCounts.INTEGER);
	}
