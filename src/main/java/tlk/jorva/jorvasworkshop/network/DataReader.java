...
public class DataReader {
    ...
    public int readData(tlk.jorva.jorvasworkshop.network.IBitCount count) {
    ...
    public int readSignedData(tlk.jorva.jorvasworkshop.network.IBitCount count) {
    ...
    public String readString(tlk.jorva.jorvasworkshop.network.IBitCount bits) {
